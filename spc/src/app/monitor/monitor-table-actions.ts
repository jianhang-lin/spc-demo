...
export let monitorsEnableActionsRules: Array<EnableActionRule> = [
...
export let monitorsEnableActionsRulesSite: Array<EnableActionRule> = [
  { id: ActionType.edit, isSingleSelection: true },
...
export let monitorsEnableActionsRules42Q: Array<EnableActionRule> = [
  { id: ActionType.edit, isSingleSelection: true },
  { id: ActionType.copy, isSingleSelection: true },
  { id: ActionType.delete, isSingleSelection: true },
  { id: ActionType.view, isSingleSelection: true },
...
export let monitorsTableActions: Array<TableAction> = [
    {
        id: ActionType.view,
