...
export class MonitorGroupForm extends FormGroup {
    constructor(monitorGroup?: MonitorGroup, formState?: FormState) {
        super({
          ...
          datasourceType: new FormControl(monitorGroup && monitorGroup.datasourceType ? monitorGroup.datasourceType : ''),
          ...
          name: new FormControl(monitorGroup && monitorGroup.name ? monitorGroup.name : ''),
