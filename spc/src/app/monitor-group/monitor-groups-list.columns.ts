...
export let admin42QMonitorGroupsListHeaderColumns: Array<Column> = [
           {
...
export let siteAdminMonitorGroupsListHeaderColumns = [
    {
        header: 'monitor-groups-list.login-id',
        field: 'loginId',
        filterType: 'globalFilter',
    ...
    },
    {
        ...
        placeholder: 'users-list.profiles',
        filterType: 'searchableDropdownFilter',
        uniqueKey: 'id',
        filterMatchMode: 'IN',
        optionLabel: 'profileName',
        filterPlaceholder: 'users-list.profile-filter-placeholder',
        isDisplayed: true,
        autofocus: false
    }
];
