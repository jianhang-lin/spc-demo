...
export let systemParametersEnableActionsRules: Array<EnableActionRule> = [
...
export let systemParametersEnableActionsRulesSite: Array<EnableActionRule> = [
  { id: ActionType.edit, isSingleSelection: true },
...
export let systemParametersEnableActionsRules42Q: Array<EnableActionRule> = [
  { id: ActionType.edit, isSingleSelection: true },
  { id: ActionType.copy, isSingleSelection: true },
  { id: ActionType.delete, isSingleSelection: true },
  { id: ActionType.view, isSingleSelection: true },
...
export let systemParametersTableActions: Array<TableAction> = [
    {
        id: ActionType.view,
