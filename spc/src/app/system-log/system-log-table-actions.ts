...
export let systemLogsEnableActionsRules: Array<EnableActionRule> = [
...
export let systemLogsEnableActionsRulesSite: Array<EnableActionRule> = [
  { id: ActionType.edit, isSingleSelection: true },
...
export let systemLogsEnableActionsRules42Q: Array<EnableActionRule> = [
  { id: ActionType.edit, isSingleSelection: true },
  { id: ActionType.copy, isSingleSelection: true },
  { id: ActionType.delete, isSingleSelection: true },
  { id: ActionType.view, isSingleSelection: true },
...
export let systemLogsTableActions: Array<TableAction> = [
    {
        id: ActionType.view,
