...
export class SystemLogListComponent implements OnInit, AfterViewInit {
  ...
  enableActionsRules = systemLogsEnableActionsRules;
  availableTableActions = systemLogsTableActions;
  filterBySite;
  filterByPlant;
  filterByCustomer;
  ...
  getLoggedUserInfo() {
    ...
    this.enableActionsRules = this.is42qSite ? systemLogsEnableActionsRules42Q : systemLogsEnableActionsRulesSite;
    this.monitorGroupService.setIs42qSite(this.is42qSite);
    this.tableColumns = this.is42qAdmin && this.is42qSite ?
      systemLogsColumns42QAdmin : systemLogsColumnsSite;
