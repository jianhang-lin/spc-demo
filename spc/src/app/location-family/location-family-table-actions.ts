...
export let locationFamiliesEnableActionsRules: Array<EnableActionRule> = [
...
export let locationFamiliesEnableActionsRulesSite: Array<EnableActionRule> = [
  { id: ActionType.edit, isSingleSelection: true },
...
export let locationFamiliesEnableActionsRules42Q: Array<EnableActionRule> = [
  { id: ActionType.edit, isSingleSelection: true },
  { id: ActionType.copy, isSingleSelection: true },
  { id: ActionType.delete, isSingleSelection: true },
  { id: ActionType.view, isSingleSelection: true },
...
export let locationFamiliesTableActions: Array<TableAction> = [
    {
        id: ActionType.view,
