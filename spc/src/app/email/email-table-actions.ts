...
export let emailsEnableActionsRules: Array<EnableActionRule> = [
...
export let emailsEnableActionsRulesSite: Array<EnableActionRule> = [
  { id: ActionType.edit, isSingleSelection: true },
...
export let emailsEnableActionsRules42Q: Array<EnableActionRule> = [
  { id: ActionType.edit, isSingleSelection: true },
  { id: ActionType.copy, isSingleSelection: true },
  { id: ActionType.delete, isSingleSelection: true },
  { id: ActionType.view, isSingleSelection: true },
...
export let emailsTableActions: Array<TableAction> = [
    {
        id: ActionType.view,
